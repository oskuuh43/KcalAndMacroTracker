...
def load_food_data():
    ...
    # Convert 'Calories' and 'Protein' to numeric types
...
def get_high_protein_options(df, min_protein_ratio=0.1):
    ...
    :return: DataFrame of food items meeting the criteria.
    """
    ...
    # Drop rows with NaN values in 'Protein' or 'Calories' columns
